...
#select 
select title, release_year, imdb_score, imdb_votes, genres from netflix_shows where genrers contains '%animation%' AND imdb_votes > 6000 AND release_year >2016 AND imdb_score > 7.0 ORDER BY imdb_votes DESC;